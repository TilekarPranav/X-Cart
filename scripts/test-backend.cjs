/**
 * Backend smoke-test script (CommonJS version).
 *
 * Usage:
 *   XCART_ADMIN_EMAIL=you@example.com XCART_ADMIN_PASSWORD=secret node scripts/test-backend.cjs
 *
...
async function main() {
  ...
  const roles = me.body && me.body.data && me.body.data.roles
